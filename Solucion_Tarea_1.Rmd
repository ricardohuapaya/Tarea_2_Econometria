...
author: "Integrantes: Sebasthián Valverde Martínez "
...
$$
Costo = \beta_{0}+ \beta_{1}trabajo+\beta_{2}capital+\beta_{3}combustible+\beta_{4}produccion +\mu
$$

### 2.1 Resumen: Analisis Descriptivo

Realizamos un analisis grafico para nuestras 5 variables: ``Costo``, ``salario``, ``Capital``, ``Combustible`` y ``produccion``  se puede apreciar en el siguiente gráfico que existe cierto nivel de correlación negativa entre el consumo y el precio. 
...
```
Cuando las variables explicativas toman el valor de 0 los costos son negativos, luego interpretando los coeficientes de las variables explicativas en las pruebas t. Cabe resaltar que _las tres primeras variables explicativas_ tienen rendimientos decrecientes luego la cuarta variable de combustible  presenta redimientos crecientes a escala 

...
Esto nos dice que en la nueva regresión se observan estimadores insesgados pero que no son los mejores estimadores linealmente independientes y cuyos errores estándar son incorrectos.
Utilizamos la correción de White donde el error estándar asociado con el coefficiente de Price, el estadistico t y el pvalue se ven afectados.
Sin embargo no cambia de manera significativa el efecto de Price en explicar la regresión.

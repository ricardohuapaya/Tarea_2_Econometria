...
```
No hay evidencia de singularidades, por lo tanto no existe multicolinealidad perfecta


```{r, echo=FALSE}
cor(datos_reg$Costo, datos_reg$Produccion ,method="pearson")
cor(datos_reg$Costo, datos_reg$Trabajo ,method="pearson")
cor(datos_reg$Costo, datos_reg$Capital ,method="pearson")
cor(datos_reg$Costo, datos_reg$Combustible ,method="pearson")
...
```
Se rechaza Ho entonces existe autocorrelación
